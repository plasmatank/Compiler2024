...
//    }
    ...
    public void printResult(String rs_value, String rs_name){
        if (rs_name.equals("标识符")) {
            ...
            } else if (rs_value.equals("float")) {
                threeElements.add(new ArrayList<>(Arrays.asList(rs_value, "KW", "6")));
            } else if (rs_value.equals("if")) {
                threeElements.add(new ArrayList<>(Arrays.asList(rs_value, "KW", "7")));
            } else if (rs_value.equals("else")) {
                threeElements.add(new ArrayList<>(Arrays.asList(rs_value, "KW", "8")));
            } else {
